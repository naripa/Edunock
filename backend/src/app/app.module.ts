...
import { StudenClassListComponent } from './studen-class/studen-class-list.component';
import { ChaptersComponent } from './chapters/chapters-list.component';
...
@NgModule({
  declarations: [AppComponent, BackendLayoutComponent, SimpleLayoutComponent, P404Component, StudenClassListComponent, ChaptersComponent],
  imports: [
    BrowserModule,
